            ...
            if frame is not None:
                ...
                for res in resultyolo:
                    if res["label"] == "whole":
                        ...
                        listofimages = os.listdir("../CompareFaces/mlbackend/assets/faceimages/") # Need to change this during deployment
                        ...
                        try:
                            for images in listofimages:
                                if images != ".DS_Store":
                                    ...
                                    # Load the cascade
                                    img2 = '../CompareFaces/mlbackend/assets/faceimages/'+images # Need to change this during deployment
